...
public class TabuleiroConsole {
	...
	private String nivel1 = "1";
        private String nivel2 = "2"; 
        private String nivel3 = "3";
	...
	private void cicloDoJogo() {
		try {
			...
			if(nivel1.equals(nivel.getNivel())){
				Pontuacao p = new Pontuacao(5);
				base.inserePontos(p);
			} else if (nivel2.equals(nivel.getNivel())) {
				Pontuacao p = new Pontuacao(10);
				base.inserePontos(p);
			} else if (nivel3.equals(nivel.getNivel())) {
